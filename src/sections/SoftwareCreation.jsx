...
const projectData = [
  {
    ...
    tech: "HTML, CSS, JavaScript (React.js and Next.js)",
  ...
  },
  {
    ...
    info: "A fully responsive modern full stack image sharing social media application with all advanced social media features such as Google authentication, create/edit/delete/save images, like/comment on other people's posts, and search and lter images.",
  ...
  },
  {
    ...
    info: "A chat app where users can enter a chat room with their username and the room ID, and chat with everyone present in the room in real time.",
    tech: "HTML, CSS, JavaScript (React.js and Node.js)",
  ...
  },
  {
    ...
    info: "A beautiful website that lists our top 10 lms of all time. As we watch more movies, we can always update our list and keep track of which movies to recommend to people.",
    tech: "HTML, CSS, Python (Flask and WTForms), SQLite, SQLAlchemy",
